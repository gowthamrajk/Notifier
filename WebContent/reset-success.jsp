...
<meta http-equiv='refresh' content='8;URL=landing.jsp'>
...
<center>
  <div class="row col-md-10 col-md-offset-3">
   ...
   <center><img src="img/success.gif" width="200px" height="200px"></center>
    <br><h2><br/>Password updated Successfully !!!</h2>
    <br><h4>You will be redirected to login page in few Seconds</h4>
   </div>
  </div>
 <br>
 </center>
